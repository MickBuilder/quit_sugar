...
// Using standardized AppScreen base class for consistent state management
      ...
      children: [
        ...
        ref.watch(onboardingDataProvider).when(
          data: (data) {
            ...
            // Calculate days passed based on target days (assuming 60-day program)
            final daysPassed = (60 - data.targetDays).clamp(0, 60);
